...
function payeeCalc(basic, benefits){//function calculates the PAYE, takes basic salary and benefits as parameters.
    ...
    if (monthlyTaxablePay>=1 && monthlyTaxablePay<=24000){
      ...
      if (payee<=0){//for all the monthly taxable pay less or equal to 24000, no payee is deducted
        ...
        console.log("Invalid Basic Salary or Benefits");
    }
...
var result1 = payeeCalc(basic,benefits)//calls payee calculator, invokes it and assigns its return value to variable result1
var result2 = nhifDedcutions(basic, benefits);//calls nhifDedcutions, invokes it and assigns the returned value to variable result2
var result3 = NSSF();//NSSF function is invoked the result is assigned to variable result3
var grossSal = grossSalary(basic,benefits);//calls grossSalary function and invokes it, then assigns the returned value to a variable grossSal )
